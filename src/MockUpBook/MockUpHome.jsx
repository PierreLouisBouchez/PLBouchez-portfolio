...
function MockUpHome() {
    ...
    return (
        <div className='h-[100vh] md:flex-row flex-col flex bg-[#eeeeee] border-[#613a00] text-gray-800 font-Victor '>
            ...
            <Canvas className="h-full md:w-2/3 w-full" shadows camera={{ position: [1, 2, 1], fov: 60 }} >
