...
const age= new Date().getFullYear() - 1999 -(new Date() < new Date(new Date().getFullYear(), 11, 2)) + " ";

const dialogue=["Hello  ! \n\n\nJe suis Pierre-Louis Bouchez, un développeur passionné de "+ age +"ans"]
...
export default function About(){
    ...
    return (
        <div className=" h-full xl:p-12"> 
            ...
            <div className="relative select-none h-full w-full    grid xl:grid-cols-4 grid-cols-2 grid-rows-2 xl:gap-4 " >
                    <h2 className="text-gris grid-item h-full xl:col-auto col-span-3 items-center flex justify-center  ">
                        <img
                            src={`/Images/pp.webp`}
                ...
                <div className="text-gris relative grid-item h-full p-8 col-span-3 ">
                    {dialogue[0]} 
